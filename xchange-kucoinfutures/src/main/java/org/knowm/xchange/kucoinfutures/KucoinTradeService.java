...
public class KucoinTradeService extends KucoinTradeServiceRaw implements TradeService {
  ...
  public String placeLimitOrder(LimitOrder limitOrder) throws IOException {
    return kucoinCreateOrder(KucoinAdapters.adaptLimitOrder(exchange, limitOrder)).getOrderId();
  }

  @Override
  public String placeMarketOrder(MarketOrder marketOrder) throws IOException {
    return kucoinCreateOrder(KucoinAdapters.adaptMarketOrder(exchange, marketOrder)).getOrderId();
  }

  @Override
  public String placeStopOrder(StopOrder stopOrder) throws IOException {
    return kucoinCreateOrder(KucoinAdapters.adaptStopOrder(exchange, stopOrder)).getOrderId();
  }
  ...
  private OpenOrders convertOpenOrders(Collection<OrderResponse> orders, OpenOrdersParams params) {
    ...
    orders.stream()
        .map(order -> KucoinAdapters.adaptOrder(exchange, order))
  ...
  public Collection<Order> getOrder(OrderQueryParams... orderQueryParams) throws IOException {
    ...
    for (OrderQueryParams params : orderQueryParams) {
      try {
        OrderResponse res = getKucoinOrder(params);
        rtn.add(KucoinAdapters.adaptOrder(exchange, res));
